<template>
    <div class="card feed">
        <div class="feed-content"> <span class="feed-time">{{ item.update_date }}</span><span class="feed-source">Category: <router-link :to="'/category/' + item.category" v-text="item.category_name" class="feed-minor-link"></router-link></span>
