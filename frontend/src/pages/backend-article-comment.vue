            ...
            <div class="comment-items-wrap">
                <div v-for="item in comments.data" class="comment-item">
                    <a href="javascript:;" class="comment-author-avatar-link">
                        <img src="/static/avatar.png" alt="" class="avatar-img">
                    </a>
                    <div class="comment-content-wrap">
                        ...
                        <div class="comment-footer">
                            ...
                            <a v-if="item.is_delete" @click="recover(item._id)" href="javascript:;" class="comment-action-item comment-reply">Resume</a>
                            <a v-else @click="deletes(item._id)" href="javascript:;" class="comment-action-item comment-reply">Delete</a>
                        </div>
                    </div>
                </div>
            </div>
